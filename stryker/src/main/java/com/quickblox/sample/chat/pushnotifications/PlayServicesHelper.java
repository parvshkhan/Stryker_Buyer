...
import com.quickblox.sample.chat.ApplicationSingletonBuyer;
...
public class PlayServicesHelper {
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = ApplicationSingletonBuyer.getInstance().getAppVersion();
    ...
    private void storeRegistrationId(String regId) {
        final SharedPreferences prefs = getGCMPreferences();
        int appVersion = ApplicationSingletonBuyer.getInstance().getAppVersion();
